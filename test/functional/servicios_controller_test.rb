...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { direccion_final: @servicio.direccion_final, direccion_inicial: @servicio.direccion_inicial, observaciones: @servicio.observaciones }
    end
  ...
  test "should update servicio" do
    put :update, id: @servicio, servicio: { direccion_final: @servicio.direccion_final, direccion_inicial: @servicio.direccion_inicial, observaciones: @servicio.observaciones }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
